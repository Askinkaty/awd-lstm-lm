...
from utils import batchify, get_batch, repackage_hidden, print_hidden
...
def evaluate(data_source, batch_size=10):
    ...
    for i in range(0, data_source.size(0) - 1, args.bptt):
        ...
        if isinstance(model, torch.nn.DataParallel):
            total_loss += len(data) * criterion(model.module.decoder.weight, model.module.decoder.bias, output, targets).data
        else:
